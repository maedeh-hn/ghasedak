...
import {  getSmsByIdParent } from '../../../../../services/smsRequestManagement/sms';
// import {OriginEnum, SmsStatusReportEnum} from "../../../utils/enums";
// import SmsDetailModal from "./modals/SmsDetailsModal";
// import useModal from "../../../hooks/useModal";
// import {fDateTimeJalali} from "../../../utils/formatTime";
...
const SmsDetailsWithModalParent = ({smsId, text,userId}) => {
    const INITIAL_VALUES = {
        UserId: userId,
        Id:smsId
    };
    const [filterValue, setFilterValue] = useState(INITIAL_VALUES);
    const {data, isLoading, refetch} = useQuery(['SingleSmsListParent', filterValue], () => getSmsByIdParent(filterValue),
    {
        enabled: false
    }
);
                        ...
                        <TableContainer>
                            <Table>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow>
                                        <TableCell align="left">
                                            قیمت : {numberWithCommas(data?.price)}
                                        </TableCell>
                                        <TableCell align="left">
                                            تعداد : {data?.count}
                                        </TableCell>
                                    ...
                                    <TableRow sx={{
                                        ...
                                        <TableCell align="left">
                                            تاریخ ثبت : {fDateTimeJalali(data?.sendDate)}
                                        </TableCell>
                                        <TableCell align="left">
                                            تاریخ ارسال : {fDateTimeJalali(data?.actualSendDate)}
                                        </TableCell>
                                    ...
                                    <TableRow sx={{
                                        ...
                                        <TableCell align="left">
                                            مبدا ارسال : {OriginEnum[data?.origin]}
                                        </TableCell>
                                        <TableCell align="left">
                                            زبان : {data?.isUnicode ? 'فارسی' : 'انگلیسی'}
                                        </TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell align="left">
                                            کد شناسه سرویس دهنده : {data?.providerResponseCode}
                                        </TableCell>
                                    </TableRow>
                                    <TableRow sx={{
                                        display: !more && 'none'
                                        ...
                                        <TableCell align="left">
                                            {' '} ارسال مجدد شده :
                                            {data?.reboundFailure ? 'بله' : 'خیر'}
                                        </TableCell>
                                        <TableCell align="left">
                                            بازگشت هزینه
                                            : {data?.refund ? 'بازگشت داده شده' : 'بازگشت داده نشده'}
                                        </TableCell>
                                    ...
                                    <TableRow sx={{
                                        ...
                                        <TableCell align="left">
                                            وضعیت ارسال : {SmsStatusReportEnum[data?.status]}
                                        </TableCell>
                                    </TableRow>
                                    ...
                                    <TableRow sx={{
                                        ...
                                        <TableCell align="left">
                                            شناسه مرجع کاربر : {data?.clientReferenceId}
                                        </TableCell>
                                        <TableCell align="left">
                                            تعداد تکرار گزارش وضعیت : {data?.statusTryCount}
                                        </TableCell>
                                    </TableRow>
...
export default SmsDetailsWithModalParent;
