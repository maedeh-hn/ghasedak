...
import { addAutoSettingContacyGroupParent } from '../../../../../../../services/contact/group-settings';
// import CustomMenuItem from "../../../../../../../components/CustomMenuItem";

const AutoRegisterFormParent = ({ item, close ,userId}) => {
...
const onSubmit = async (values) => {
  ...
  const response = await addAutoSettingContacyGroupParent({
    ...values,
    userId:userId,
...
export default AutoRegisterFormParent;