...
import { removeDuplicatedGroupNumbersParent } from '../../../../../services/contact/group-number';

const GroupNumberTableHeaderParent = ({ refetch, openExcelModal, openAddNumberModal, openAddGroupNumberModal }) => {
  const params = useParams();
  console.log(params);
  const { enqueueSnackbar } = useSnackbar();

  const sendDeleteDuplicatedNumberRequestHandler = async () => {
    const response = await removeDuplicatedGroupNumbersParent(params.GroupId,params.userId);
...
export default GroupNumberTableHeaderParent