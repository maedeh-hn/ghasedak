...
import { createMultipleGroupNumbersParent } from '../../../../../../services/contact/group-number';


const AddGroupNumberModalParent = ({ state, handleClose, refetch }) => {
  ...
  const onSubmit = async (values) => {
    ...
    const response = await createMultipleGroupNumbersParent(params.GroupId,params.userId, temp);
    if (response.isSuccess) {
      refetch();
      enqueueSnackbar(` شماره تلفن ها با موفقیت اضافه شد.`);
      handleClose();
    }
  };
...
export default AddGroupNumberModalParent;
