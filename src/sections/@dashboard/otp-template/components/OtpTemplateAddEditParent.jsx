...
import {createOtpTemplateparent, editOtpTemplate} from '../../../../services/smsRequestManagement/otpTemplate';
import {useNavigate} from 'react-router-dom';
import {PATH_DASHBOARD} from '../../../../routes/paths';


const OtpTemplateAddEditParent = ({data}) => {
    ...
    const methods = useForm({
        ...
        defaultValues: {
            ...data,
            editedMessage: data?.editedMessage || data?.message || '',
            name: data?.name || ''
        },
    });
    ...
    const onSubmit = async (values) => {
        let response;
        if (data) {
            response = await editOtpTemplateParent(values);
        } else {
            response = await createOtpTemplateparent(values);
        }
                    ...
                    <Box>
                        ...
                        <Box>
                            ...
                            >
                                ...
                                }} name="editedMessage" label="متن قالب" fullWidth/>
                            </Box>
                        </Box>
                    </Box>
                </Box>
...
export default OtpTemplateAddEditParent;
