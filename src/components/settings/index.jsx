...
import SettingBorderRadius from './SettingBorderRadius';
...
export default function Settings() {
  ...
  const notDefault =
    ...
    themeBorderRadius !== defaultSettings.themeBorderRadius ||
          ...
          <>
            <RootStyle {...varSidebar}>
              <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ py: 2, pr: 1, pl: 2.5 }}>
                <Typography variant="subtitle1">تنظیمات</Typography>
                <div>
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">حالت</Typography>
                    <SettingMode />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">سایز متن</Typography>
                    <SettingFontSize />
                  </Stack>
