...
import UploadVideoFile from '../upload/UploadVideoFile';
...
RHFUploadVideoFile.propTypes = {
  name: PropTypes.string,
};

export function RHFUploadVideoFile({ name, ...other }) {
  const { control } = useFormContext();
    ...
    <Controller
      ...
      render={({ field, fieldState: { error } }) => {
        ...
        return (
          ...
          filevideo={other.filevideo}
          isVideoDownload={other.isVideoDownload}
          setIsvideoDownload={other.setIsvideoDownload}
          stage={other.stage}
            accept="video/*"
            file={field.value}
            error={checkError}
