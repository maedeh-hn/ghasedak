...
const GroupSmsReportChartTableParent = () => {
    ...
    const {data, isLoading} = useQuery(['BulkSmsDiagram', filterValue], () =>
    searchReceptorBulkParent(filterValue)
    );
...
export default GroupSmsReportChartTableParent